...
This version works with Python 2.x (tested with 2.7)
...
class ImxBin:
    def __init__(self,filename):
        ...
        self.file_data = self.file.read(512*1024)   #this should be enough 
...
if __name__ == "__main__":
    ...
    if(sys.version_info[0] == 3):
        print("You're using Python 3.x, which is not supported by this script")
        quit()
